...
function route() {
  return (
    <div>
     ...
     <p>Upgrade your plans to check multiple courses </p>
    ...
    >
      ...
      <ul className="mt-6 space-y-2">
        ...
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700"> Unlimited Course access </span>
        </li>
    ...
    <div className="rounded-2xl border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
      ...
      <ul className="mt-6 space-y-2">
        ...
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700"> 5 courses access </span>
        </li>
      </ul>
